...
**Mục đích cuối cùng:** Có một bản demo hoàn chỉnh để trình bày cho nhà đầu tư, chứng minh được tiền chạy từ đầu đến cuối trên blockchain thông qua hệ thống escrow
...
**Giải pháp của AKAO:** Escrow on-chain — tiền nằm trong ví blockchain do smart contract logic kiểm soát, không bên nào (kể cả sàn) có thể lấy tiền tùy ý. Buyer thanh toán → tiền vào escrow → seller giao hàng → tiền release. Minh bạch, kiểm chứng được trên blockchain.
...
|---------------------|--------------------|
| Buyer thanh toán → tiền vào ví escrow on-chain (thấy được trên blockchain explorer) | Chứng minh tiền thật sự nằm trên blockchain, không phải database nội bộ |
...
| Seller giao hàng → buyer xác nhận → tiền release cho seller | Chứng minh vòng đời đơn hàng hoàn chỉnh, escrow hoạt động đúng |
...
1. **Checkout và thanh toán escrow** — flow cốt lõi, không có cái này thì không có sản phẩm
2. **Trang trạng thái đơn hàng** — buyer thấy tiền đang "giữ" trong escrow
...
| Lịch sử chi tiết escrow (timeline) | Nice-to-have, không cần cho lần demo đầu |
...
|------|-----|------------------------------|
| Tuần 2 | Tạo được ví escrow trên testnet từ key của buyer + seller | Thuật toán derivation hoạt động, nền tảng kỹ thuật vững |
| Tuần 4 | Buyer thanh toán thành công, tiền vào ví escrow, thấy trên blockchain explorer | **Checkpoint quan trọng nhất** — core value proposition hoạt động |
