...
/**
 * @file ast_nodes.hpp
 * @brief AST node definitions for Akao runtime engine
 * @details Complete definitions for all AST node types used in runtime execution
 * 
 * @id akao:component:core:engine:runtime:ast-nodes:v1
 * @doc AST node definitions supporting Pure Logic language execution and runtime management
 * @specification Complete AST node type definitions with runtime compatibility
 * @scope Runtime AST node definitions for execution engine
 * @timeline 2025-01-15
 * @rationale Provide complete AST node definitions to resolve compilation errors in runtime system
 * @methodology Standard C++ class definitions with virtual destructors and type safety
 * @references ["akao:component:core:engine:runtime:akao-runtime:v1"]
 */
