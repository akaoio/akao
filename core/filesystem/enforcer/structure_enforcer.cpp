#include "structure_enforcer.hpp"
#include <chrono>
#include <algorithm>
#include <fstream>
#include <filesystem>
...
EnforcementResult StructureEnforcer::checkRules(const scanner::DirectoryInfo& directory_info, 
    ...
    for (const auto& rule : rules_) {
        ...
        std::vector<engine::validator::Violation> rule_violations;
...
std::vector<EnforcementAction> StructureEnforcer::generateActions(const std::vector<engine::validator::Violation>& violations) {
...
engine::validator::Violation StructureEnforcer::createViolation(const EnforcementRule& rule,
