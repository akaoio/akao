#include "../cli/cli-command-tests/v1.hpp"
#include "../compliance/self-validation-test/v1.hpp"
#include "../unit/universal-validator-test/v1.hpp"
...
int main() {
    ...
    printSuiteResults("Rule Tests", rule_test_passed ? 1 : 0, rule_test_passed ? 0 : 1, rule_test_passed);
